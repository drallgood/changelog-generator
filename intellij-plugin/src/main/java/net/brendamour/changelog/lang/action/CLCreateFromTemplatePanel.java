...
public class CLCreateFromTemplatePanel {
    private JPanel myMainPanel;
    private JPanel myAttrPanel;
    private JTextField myFilenameField;
    private final String[] myUnsetAttributes;
    private final ArrayList<Pair<String, JComponent>> myAttributes = new ArrayList<>();
    ...
    private final Map<String, JComponent> myFieldType;

    public CLCreateFromTemplatePanel(final String[] unsetAttributes, final boolean mustEnterName,
                                     @Nullable final AttributesDefaults attributesDefaults, Map<String, JComponent> fieldType) {
    ...
    private void updateShown() {
        ...
        for (@NlsSafe String attribute : myUnsetAttributes) {
            ...
            if (myFieldType.containsKey(attribute)) {
                field = myFieldType.get(attribute);
            } else {
            ...
            if (field instanceof JTextField) {
                ...
                if (myAttributesDefaults != null) {
                    ...
                    if (defaultValue != null) {
                        ...
                        if (selectionRange != null) {
                            setPredefinedSelectionFor(textField, selectionRange);
                        }
                    }
                }
