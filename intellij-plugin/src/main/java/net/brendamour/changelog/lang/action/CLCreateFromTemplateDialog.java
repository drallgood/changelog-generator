...
public class CLCreateFromTemplateDialog extends DialogWrapper {
    private static final Logger LOG = Logger.getInstance(CLCreateFromTemplateDialog.class);
    @NotNull private final PsiDirectory myDirectory;
    @NotNull private final Project myProject;
    private PsiElement myCreatedElement;
    private final CLCreateFromTemplatePanel myAttrPanel;
    ...
    public CLCreateFromTemplateDialog(@NotNull Project project,
                                      @NotNull PsiDirectory directory,
                                      @NotNull FileTemplate template,
                                      @Nullable final AttributesDefaults attributesDefaults,
                                      @Nullable final Properties defaultProperties, Map<String, JComponent> typeMap) {
        super(project, true);
        ...
        if (unsetAttributes != null) {
            myAttrPanel = new CLCreateFromTemplatePanel(unsetAttributes, mustEnterName, attributesDefaults, typeMap);
